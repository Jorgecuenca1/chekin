...
urlpatterns = [
    ...
    path('nosotros', users_views.nosotros, name='nosotros'),
    path('contactanos', users_views.contactanos, name='contactanos'),
    path('gestioneventos', users_views.gestioneventos, name='gestioneventos'),
    path('agregareventos', users_views.agregareventos, name='agregareventos'),
    path('reporte/<int:id>/', users_views.reporte, name='reporte'),
    path('politicas', users_views.politicas, name='politicas'),
    path('faq', users_views.faq, name='faq'),
    path('terminosycondiciones', users_views.terminosycondiciones, name='terminosycondiciones'),
    ...
    path('signupenterprise', users_views.signupEnterprise, name='signupEnterprise'),
